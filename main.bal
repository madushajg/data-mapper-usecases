...
public function main() {
    ...
    CovidEntry[] entries = [
        {iso_code: "AFG", country: "Afghanistan", cases: 10, deaths: 0, recovered: 0, active: 10, daily_cases: [1, 2, 3, 4, 5]},
        {iso_code: "LK", country: "Sri Lanka", cases: 20, deaths: 0, recovered: 20, active: 0, daily_cases: [1, 2, 3, 4, 5]},
        {iso_code: "US", country: "United States", cases: 30, deaths: 20, recovered: 10, active: 0, daily_cases: [1, 2, 3, 4, 5]},
        {iso_code: "AUS", country: "Australia", cases: 40, deaths: 10, recovered: 10, active: 20, daily_cases: [1, 2, 3, 4, 5]}
    ];
